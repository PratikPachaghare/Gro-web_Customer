...
const WhyChooseUs = () => {
  const reasons = [
    ...
    },
    {
      ...
      description:
        'Future-proof technology that grows with your business and adapts to your needs.',
    ...
    },
    {
      ...
      description:
        'Competitive rates without hidden costs. Get maximum value for your investment.',
    ...
    },
    {
      ...
      description:
        'We use the latest technologies and best practices to build superior products.',
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${reason.color} rounded-2xl flex items-center justify-center mb-6 transform transition-transform duration-300 hover:rotate-12`}
                >
